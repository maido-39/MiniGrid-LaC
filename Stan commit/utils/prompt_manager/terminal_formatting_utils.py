...
# `re` (regular expressions) is used here to:
# - detect and extract leading newline characters (`\n`)
# - without manually looping through the string
import re
...
def cprint(text: str,
    ...
    # --------------------------------------------------------
    # Preserve leading newline characters
    # --------------------------------------------------------
    # This regex splits the text into:
    #   1) any number of leading '\n'
    ...
    leading_newlines = match.group(1)
    body = match.group(2)
    
    # --------------------------------------------------------
    # Apply indentation to each line of the remaining text
    # --------------------------------------------------------
    # - split the body into lines
    # - prepend indentation to every non-empty line
    # - rejoin them with newline characters
    indented_body = "\n".join(
    ...
    # --------------------------------------------------------
    # Order matters:
    #   1) preserved newlines
    #   2) style + color
    #   3) indented text
    #   4) Style.RESET_ALL to stop formatting
    print(f"{leading_newlines}{style}{color}{indented_body}{Style.RESET_ALL}")
